...
<head>
    <meta charset="utf-8">
    <title>HRTMS Employee Login</title>
...
<body>
    ...
    <div class="navbar navbar-fixed-top">
        <div class="navbar-inner">
                ...
                <a class="brand" href="<?php echo base_url();?>"><img width="120px" src="<?php echo base_url();?>hrtms_resources/images/logo.jpg" alt="">  AMI - Human Resource Training and Management System</a>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div id="login-wraper" class="login-div">
            <form class="form login-form" action='<?php echo base_url();?>auth/verify_user' method="post">
                <legend><span class="blue">Employee</span> Login</legend>
                ...
                <div class="footer">
                    <a class="btn btn-info" href="<?php echo base_url();?>employee/login/?forgot=pass">Forgot Password</a>
        ...
        <div id="login-wraper" class="forgot-div" style="height: 280px;">
            <form class="form login-form" action='<?php echo base_url();?>auth/verify_user/forgot_password' method="post">
                ...
                <div class="footer">
                    <a class="btn btn-info" href="<?php echo base_url();?>employee/login"><i class="icon-reply"></i> Back</a>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function($) {
            ...
            $.backstretch([
                "<?php echo base_url();?>hrtms_resources/images/bg1.jpg", 
                "<?php echo base_url();?>hrtms_resources/images/bg2.jpg",
                "<?php echo base_url();?>hrtms_resources/images/bg1.jpg", 
                "<?php echo base_url();?>hrtms_resources/images/bg3.jpg"
