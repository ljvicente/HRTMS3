					...
					<div class="row-fluid">
						...
						<div class="span12">
							<div class="alert alert-success">
									<b>Note:</b>
									<ul>
										<li>Here you can edit the User information and account details</li>
										<li>Deactive or Activate user account</li>
									</ul>						
							</div>
					...
					<!-- ADD HR START -->
						...
						<div class="widget-box">
							...
							<div class="widget-header">
								<h4><i class="icon-user"></i> Edit User</h4>
								...
								<div class="widget-main">
									<div class="row-fluid">
										<div id="infoMessage" align="center"><?php 
											$message = $this->session->flashdata('user_message');
