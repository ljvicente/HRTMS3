...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>About the Developers - AMI</title>
		...
		<link rel="stylesheet" href="<?php echo base_url();?>hrtms_resources/css/<?php if($this->session->userdata("permission") == "Client") { echo 'client'; } else if($this->session->userdata("permission") == "Trainer") { echo 'training'; } else if($this->session->userdata("permission") == "HR") { echo 'hr'; } else if($this->session->userdata("permission") == "Trainee") { echo 'manpower'; } else if($this->session->userdata("permission") == "Administrator") { echo 'admin'; } ?>/custom.css" />
