...
<h1>Attendance : <?php echo $this->input->post('batch')?></h1>
	...
	<tbody>
		<?php if(isset($records)) : foreach($records as $row) : ?>
				<tr>
					...
					<td class="center" width="60px"><?php echo $row->training_days;?></td>
					<td class="center" width="60px"><?php echo $row->present_days?></td>
