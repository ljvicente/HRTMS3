...
if (!function_exists('buildDayDropdown'))
{
    ...
    {	
        ...
        return form_dropdown($name, $day_list, $value, "class='input-small'");
    }
}	
...
if ( !function_exists('buildYearDropdown'))
{
    ...
    {        
        ...
        return form_dropdown($name, $year_list, $value,  "class='input-small'");
    }
}
...
if (!function_exists('buildMonthDropdown'))
{
    function buildMonthDropdown($name='',$value='')
    {
        $month=array(
            ...
            '11'=>'November',
            '12'=>'December');
        return form_dropdown($name, $month, $value, "class='input-medium'");
    }
}
